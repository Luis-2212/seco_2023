...
<div class="content-wrapper px-2 py-3 pb-5 text-bg-light contenedor-principal">
  ...
  <button class="btn btn-warning shadow-md" type="button" data-bs-toggle="collapse" data-bs-target="#seccionRegistrarProducto" aria-expanded="false" aria-controls="seccionRegistrarProducto">
    <i class="fa-solid fa-person-circle-plus"></i> Nuevo Producto <i class="fa-solid fa-caret-down"></i>
  </button>
        ...
        <div class="d-flex gap-3">
          ...
          <div class="input-group mb-3">
            ...
            <div class="form-floating">
              ...
              <input type="text" class="form-control shadow-sm" id="nuevoNombresProducto" placeholder="Nombre completo" required>
              
              <label for="nuevoNombresProducto">Nombre completo</label>
        ...
        <div class="d-flex gap-3">
          ...
          <div class="input-group mb-3">
            ...
            <div class="form-floating">
              ...
              <input type="text" class="form-control shadow-sm validarProducto" id="nuevoIdentificacion" placeholder="Cédula o RIF" inputmode="numeric" required>
